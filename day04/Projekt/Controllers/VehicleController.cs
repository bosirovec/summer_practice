...
namespace Projekt.Controllers
{
    ...
    public class VehicleController : ApiController
    {
        ...
        public HttpResponseMessage Post([FromBody] RestVehicle input)
        {
            ...
            if (service.InsertVehicle(vehicle))
            {
        ...
        [Route("api/drive")]
        public HttpResponseMessage Put([FromUri] int vehId, [FromUri] int driveLength)
        {
        ...
        public HttpResponseMessage Delete([FromBody]Vehicle vehicle)
        {
